...
1. If you were to describe semantic HTML to the next cohort of students, what would you say?
    ...
    Using tags that are meaningful/descriptive and allow for search engine optimization.
...
5. Define mobile-first design in your own words.
    ...
    Mobile first means that you code/design for the mobile environment (smallest screen), first, and then graduate up to the desktop (largest screen) environment.
